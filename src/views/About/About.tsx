    ...
    <div id="about" className='flex flex-col justify-center '>
      ...
      <div className=' flex mt-[2rem] w-screen h-[25rem] p-[2rem]'>
        <div className=' flex flex-col w-full ml-[5rem]'>
          <div className='flex gap-[2rem] justify-evenly pt-[1rem]'>
            <div className='flex flex-col w-[10rem] h-[10rem] rounded-lg border shadow-lg text-center justify-center'>
            ...
            <div className='flex flex-col w-[10rem] h-[10rem] rounded-lg border shadow-lg text-center justify-center'>
              ...
              <div>
                <button className='font-secondary text-sm p-[0.5rem] bg-slate-400 text-white rounded-md animate-bounce' onClick={scrollToProjects}>Ver proyectos</button>
              </div>
            </div>
          </div>
