...
const Footer: React.FC = () => {
    return (
        <div className="flex flex-col justify-center bg-blue-950 h-[12rem]">   
            <div className="flex flex-col justify-center items-center max-[450px]:w-full">
                <h1 className='font-secondary text-3xl max-[450px]:text-2xl mt-[2rem] text-white'>MAGALI MARTIN</h1>
            </div>
            <div className='flex  justify-center max-[450px]:flex-row text-white'>
