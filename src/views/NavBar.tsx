...
const NavBar: React.FC = () => {
  ...
  return (
    <div className="justify-center items-center bg-black text-white p-[0.5rem] fixed w-[50%] rounded-full z-30 shadow-lg shadow-blue-700 mt-[2rem] max-[400px]:w-full max-[450px]:w-full">
